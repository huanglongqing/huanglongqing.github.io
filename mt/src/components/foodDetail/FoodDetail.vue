<template>
    ...
    <div class="food" v-show="isShow" ref="food_detail">
        ...
        <div class="rating-wrapper">
          ...
          <div class="rating-title">
            ...
            <div class="snd-title" v-if="food.rating">
                  <span class="text">{{food.snd_title}}</span> 
                  <span class="icon icon-keyboard_arrow_right"></span> 
            </div>
          </div>
          <ul class="rating-content" v-if="food.rating">
            <li 
              v-for="(rating,index) in food.rating.comment_list"
              :key="index"
              class="comment-item"
              >
              <div class="comment-header">
                <img v-if="rating.user_icon" :src="rating.user_icon" />
                <img src="./img/anonymity.png" v-if="!rating.user_icon" />
              </div>
            ...
            show(){
                ...
                this.$nextTick(()=>{
                    if(!this.detailScroll){
                        this.detailScroll = new BScroll(this.$refs.food_detail,{
                            click:true
                        });
                    }else{
